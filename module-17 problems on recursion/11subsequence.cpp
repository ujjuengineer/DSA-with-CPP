...
// input: length = 3,n=3 output: 123,

// since we have to find subsequence from first n  natural number, if length = 3 and n=5 then assume a array 1,2,3,4,5 and find all the subsets of 3 length
